#!/usr/bin/env python3
"""
Recuperation des codes promo ManoMano depuis shopilo.fr
Sursa: https://shopilo.fr/reductions/manomano.fr
"""
...
SHOPILO_URL = "https://shopilo.fr/reductions/manomano.fr"
STORE_NAME = "ManoMano"


def fetch_coupons(url=SHOPILO_URL):
    """Renvoie la liste des coupons actifs pour ManoMano depuis shopilo.fr"""
    headers = {
        "User-Agent": "Mozilla/5.0 (compatible; coupon-fetcher/1.0; +https://github.com/shopilo-fr/code-promo-manomano)"
    }
    try:
